...
require_once __DIR__ . '/admin/ajax-video.php';
require_once __DIR__ . '/inc/yoast-log-hooks.php';
require_once __DIR__ . '/inc/llms-output.php';
// load video shortcodes
$shortcodes_video = __DIR__ . '/modules/shortcodes-video.php';
if (file_exists($shortcodes_video)) {
  require_once $shortcodes_video;
}
...
require_once __DIR__ . '/inc/cpt-video.php';


require_once __DIR__ . '/modules/ai-functions.php';

if (get_option('ssseo_enable_youtube', '1') === '1') {
    // YouTube Video Blog module
require_once plugin_dir_path( __FILE__ ) . 'modules/videoblog/youtube.php';
}
