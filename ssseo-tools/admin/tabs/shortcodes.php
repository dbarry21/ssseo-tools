...
// 4) custom_social_sharing

echo '<h3><code>[social_share]</code></h3>';

echo '<p>Renders a Modal with popular sharing options.</p>';

echo '<pre><code> [social_share] </code></pre>';
echo '<?php <pre><code>echo do_shortcode([social_share])</pre></code>;?>';
